          ...
          <div class="w-full md:w-1/3 flex flex-col flex-grow flex-shrink">
            ...
            <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow-lg p-6">
              <div class="flex items-center justify-between">
                <img class="w-8 h-8 rounded-full mr-4 avatar" data-tippy-content="Author Name" src= {{ $latest_post['avatar'] }} alt="Avatar of Author">
      ...
      <div class="flex flex-wrap justify-between pt-12 -mx-6">
        ...
        <!--1/3 col -->
          <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
            ...
            <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow-lg p-6">
              <div class="flex items-center justify-between">
                <img class="w-8 h-8 rounded-full mr-4 avatar" data-tippy-content="Author Name" src={{ get_avatar_url(get_the_ID()) }} alt="Avatar of Author">
